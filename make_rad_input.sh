...
atomsk_noskew newcell.lmp -duplicate $nx $ny $nz out.lmp
...
xmax=`sed '1q;d' max_overlap.dat | awk '{print $2}'`
ymax=`sed '2q;d' max_overlap.dat | awk '{print $2}'`
xymax=`sed '3q;d' max_overlap.dat | awk '{print $2}'`

echo "Plane1: Max z along [ "$x" ] = "$xmax >> barriers.dat
echo "Plane1: Max z along [ "$y" ] = "$ymax >> barriers.dat
echo "Plane1: Max z along [ "$xy" ] = "$xymax >> barriers.dat

mv solids/overlap.dat solids/overlap1.dat
mv OverlapPlot.png solids/OverlapPlot1.png
mv Slices.png solids/Slices1.png
mv max_overlap.dat solids/max_overlap1.dat
